...
def generar_curvas_aprendizaje_xgboost():
    ...
    plt.title('XGBOOST (VALORES PRED.): GALAXIAS', fontsize=11, fontweight='bold')
    ...
    plt.title('XGBOOST (VALORES PRED.): CUÁSARES', fontsize=11, fontweight='bold')
    plt.xlabel('Filas', fontsize=10)
    plt.ylabel('F1-Score (%)', fontsize=10)
    plt.grid(True, linestyle='--', alpha=0.5, zorder=1)
    plt.xlim(2000, 73000)
    ...
    plt.title('XGBOOST (VALORES PRED.): ESTRELLAS', fontsize=11, fontweight='bold')
    plt.xlabel('Filas', fontsize=10)
    plt.ylabel('F1-Score (%)', fontsize=10)
    plt.grid(True, linestyle='--', alpha=0.5, zorder=1)
    plt.xlim(2000, 73000)
