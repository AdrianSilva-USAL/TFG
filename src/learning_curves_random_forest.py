...
def generar_curvas_aprendizaje():
    ...
    plt.title('RANDOM FOREST (VALORES PRED.): GALAXIAS', fontsize=11, fontweight='bold')
    ...
    plt.title('RANDOM FOREST (VALORES PRED.): CUÁSARES', fontsize=11, fontweight='bold')
    plt.xlabel('Filas', fontsize=10)
    plt.ylabel('F1-Score (%)', fontsize=10)
    plt.grid(True, linestyle='--', alpha=0.5, zorder=1)
    plt.xlim(2000, 73000)
    ...
    plt.title('RANDOM FOREST (VALORES PRED.): ESTRELLAS', fontsize=11, fontweight='bold')
    plt.xlabel('Filas', fontsize=10)
    plt.ylabel('F1-Score (%)', fontsize=10)
    plt.grid(True, linestyle='--', alpha=0.5, zorder=1)
    plt.xlim(2000, 73000)
